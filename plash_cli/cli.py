...
Docs: https://AnswerDotAI.github.io/plash_cli/cli.html.md"""
...
# %% ../nbs/00_cli.ipynb #a20045ed
class PlashError(Exception): pass

# %% ../nbs/00_cli.ipynb #b7d4028e
...
# %% ../nbs/00_cli.ipynb #24e62f1f
log_modes = str_enum('log_modes', 'build', 'app')

# %% ../nbs/00_cli.ipynb #4c1597b9
def logs(
    path:Path='.',    # Path to project
    name:str=None,          # Overrides the .plash file in project root if provided
